...
#     print(f"\n{'='*55}")
#     print(f"  Training {label} — All Models")
#     print(f"{'='*55}")
...
#     print(f"  Class balance: UP={int((y==1).sum())} DOWN={int((y==0).sum())}")
...
#     # Class weight to fix DOWN bias
#     spw = get_class_weight(y_train)
#     print(f"  Class weight (scale_pos_weight): {spw:.2f}")

#     # ── Model 1: Tuned XGBoost ─────────────────────
#     print("\n  Training Model 1 — Tuned XGBoost...")
#     xgb = XGBClassifier(
#         n_estimators=500,
#         max_depth=5,
#         learning_rate=0.02,
...
#     # ── Model 3: XGBoost variant ──────────────────
#     print("\n  Training Model 3 — XGBoost Variant...")
#     xgb2 = XGBClassifier(
#         n_estimators=300,
#         max_depth=7,
#         learning_rate=0.05,
...
#         verbose=False
#     )
#     xgb2_pred = xgb2.predict(X_test_sel)
#     xgb2_acc = accuracy_score(y_test, xgb2_pred)
#     print(f"  XGBoost v2 accuracy: {xgb2_acc*100:.2f}%")
...
#     #     voting='soft'
#     # )
#     # ── Voting Ensemble (best models only) ───────────
#     print("\n  Training Voting Ensemble (best models only)...")
#     ensemble = VotingClassifier(
#         estimators=[
#             ('xgb', xgb),
#             ('xgb2', xgb2)
#         ],
#         voting='soft',
#         weights=[1, 2]  # Give xgb2 double weight since it performs better
#     )
...
#     # Save best model
#     best_acc = max(xgb_acc, lgbm_acc, xgb2_acc, ens_acc)
#     best_name = ['XGBoost', 'LightGBM', 'XGBoost v2', 'Ensemble'][
#         [xgb_acc, lgbm_acc, xgb2_acc, ens_acc].index(best_acc)
#     ]
#     print(f"  Best model: {best_name} at {best_acc*100:.2f}%")

#     # Always save ensemble as primary
...
# print("=" * 55)
# print("  TradeVest — Boosted Model Training v2")
# print("  XGBoost + LightGBM + Feature Selection")
# print("  + Class Balance + Voting Ensemble")
# print("=" * 55)
...
#     ('target_5d', '5-Day')
# ]:
#     results = train_all_models(target, label)
#     all_results[label] = results

# print("\n" + "=" * 55)
# print("  FINAL SUMMARY")
# print("=" * 55)
# print(f"  {'Model':<12} {'1-Day':>8} {'3-Day':>8} {'5-Day':>8}")
# print(f"  {'-'*40}")
# for model in ['xgb', 'lgbm', 'xgb2', 'ensemble']:
#     row = f"  {model:<12}"
#     for label in ['1-Day', '3-Day', '5-Day']:
#         acc = all_results[label][model]
#         row += f" {acc*100:>7.2f}%"
#     print(row)
# print("=" * 55)

# # ── GridSearch on best model (XGBoost v2 config) ──
# print("\n" + "="*55)
# print("  GridSearch Tuning on 5-Day XGBoost v2")
# print("="*55)

# df = load_all_data('target_5d')
# available = [c for c in FEATURES if c in df.columns]
# X = df[available]
# y = df['target_5d']
...
# print("  Running GridSearch (this takes ~20 min)...")
# grid = GridSearchCV(
#     base_model,
#     param_grid,
#     cv=3,
...
# joblib.dump(best_model, f"{MODELS_DIR}/xgboost_best_5d.pkl")
# joblib.dump(scaler, f"{MODELS_DIR}/xgboost_best_scaler_5d.pkl")
# joblib.dump(top_features, f"{MODELS_DIR}/xgboost_best_features_5d.pkl")
# print(f"  Saved: xgboost_best_5d.pkl")

# # ── GridSearch on 1-Day Model ──────────────────
# print("\n" + "="*55)
# print("  GridSearch Tuning on 1-Day XGBoost v2")
# print("="*55)

# df_1d = load_all_data('target_1d')
# available_1d = [c for c in FEATURES if c in df_1d.columns]
# X_1d = df_1d[available_1d]
# y_1d = df_1d['target_1d']

# X_train_1d, X_test_1d, y_train_1d, y_test_1d = train_test_split(
#     X_1d, y_1d, test_size=0.2, random_state=42, shuffle=True
# )

# scaler_1d = StandardScaler()
# X_train_scaled_1d = pd.DataFrame(
#     scaler_1d.fit_transform(X_train_1d), columns=X_train_1d.columns
# )
# X_test_scaled_1d = pd.DataFrame(
#     scaler_1d.transform(X_test_1d), columns=X_test_1d.columns
# )

# X_train_sel_1d, X_test_sel_1d, top_features_1d = select_features(
#     X_train_scaled_1d, y_train_1d, X_test_scaled_1d
# )

# spw_1d = get_class_weight(y_train_1d)
...
# base_model_1d = XGBClassifier(
#     n_estimators=300,
#     subsample=0.8,
#     colsample_bytree=0.6,
#     scale_pos_weight=spw_1d,
#     eval_metric='logloss',
#     random_state=123,
#     verbosity=0
# )
...
#     verbose=1
# )
# grid_1d.fit(X_train_sel_1d, y_train_1d)

# print(f"\n  Best params: {grid_1d.best_params_}")
# print(f"  Best CV score: {grid_1d.best_score_*100:.2f}%")

# best_model_1d = grid_1d.best_estimator_
# y_pred_1d = best_model_1d.predict(X_test_sel_1d)
# test_acc_1d = accuracy_score(y_test_1d, y_pred_1d)
# print(f"  Test accuracy: {test_acc_1d*100:.2f}%")

# joblib.dump(best_model_1d, f"{MODELS_DIR}/xgboost_best_1d.pkl")
# joblib.dump(scaler_1d, f"{MODELS_DIR}/xgboost_best_scaler_1d.pkl")
# joblib.dump(top_features_1d, f"{MODELS_DIR}/xgboost_best_features_1d.pkl")
# print(f"  Saved: xgboost_best_1d.pkl")

# # ── GridSearch on 3-Day Model ──────────────────
# print("\n" + "="*55)
# print("  GridSearch Tuning on 3-Day XGBoost v2")
# print("="*55)

# df_3d = load_all_data('target_3d')
# available_3d = [c for c in FEATURES if c in df_3d.columns]
# X_3d = df_3d[available_3d]
# y_3d = df_3d['target_3d']

# X_train_3d, X_test_3d, y_train_3d, y_test_3d = train_test_split(
#     X_3d, y_3d, test_size=0.2, random_state=42, shuffle=True
# )

# scaler_3d = StandardScaler()
# X_train_scaled_3d = pd.DataFrame(
#     scaler_3d.fit_transform(X_train_3d), columns=X_train_3d.columns
# )
# X_test_scaled_3d = pd.DataFrame(
#     scaler_3d.transform(X_test_3d), columns=X_test_3d.columns
# )

# X_train_sel_3d, X_test_sel_3d, top_features_3d = select_features(
#     X_train_scaled_3d, y_train_3d, X_test_scaled_3d
# )

# spw_3d = get_class_weight(y_train_3d)

# base_model_3d = XGBClassifier(
#     n_estimators=300,
#     subsample=0.8,
#     colsample_bytree=0.6,
#     scale_pos_weight=spw_3d,
#     eval_metric='logloss',
#     random_state=123,
#     verbosity=0
# )
...
#     verbose=1
# )
# grid_3d.fit(X_train_sel_3d, y_train_3d)

# print(f"\n  Best params: {grid_3d.best_params_}")
# print(f"  Best CV score: {grid_3d.best_score_*100:.2f}%")

# best_model_3d = grid_3d.best_estimator_
# y_pred_3d = best_model_3d.predict(X_test_sel_3d)
# test_acc_3d = accuracy_score(y_test_3d, y_pred_3d)
# print(f"  Test accuracy: {test_acc_3d*100:.2f}%")

# joblib.dump(best_model_3d, f"{MODELS_DIR}/xgboost_best_3d.pkl")
# joblib.dump(scaler_3d, f"{MODELS_DIR}/xgboost_best_scaler_3d.pkl")
# joblib.dump(top_features_3d, f"{MODELS_DIR}/xgboost_best_features_3d.pkl")
# print(f"  Saved: xgboost_best_3d.pkl")

# print("\n" + "="*55)
# print("  ALL GRIDSEARCH COMPLETE")
# print("="*55)
# print(f"  1-Day best: {test_acc_1d*100:.2f}%")
# print(f"  3-Day best: {test_acc_3d*100:.2f}%")
# print(f"  5-Day best: {test_acc*100:.2f}%")
# print("="*55)
